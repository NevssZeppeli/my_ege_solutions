...
def g(h):
    ...
    if any(g(m) == "P1" for m in moves(h)): return "V1"
    if any(g(m) == "V1" for m in moves(h)): return "P2"
    if all(g(m) == "P1" or g(m) == "P2" for m in moves(h)): return "V2"

print([s for s in range(1, 31) if g((9,s)) == 'V1'])
print([s for s in range(1, 31) if g((9,s)) == 'P2'])
print([s for s in range(1, 31) if g((9,s)) == 'V2'])